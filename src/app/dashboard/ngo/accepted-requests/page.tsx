...
//     volunteerContact: '+91 98765 43213',
//     notes: 'Food will be delivered by 2 PM',
//   },
//   {
//     id: 2,
...
//     status: 'completed',
//     assignedVolunteer: 'Mike Brown',
//     volunteerContact: '+91 98765 43214',
//     notes: 'Successfully delivered at 3:45 PM',
//     completionDate: '2024-03-20T15:45',
//   },
//   {
//     id: 3,
...
//     status: 'scheduled',
//     assignedVolunteer: 'Lisa Chen',
//     volunteerContact: '+91 98765 43215',
//     notes: 'Delivery scheduled for 4 PM',
//   },
// ]

// export default function AcceptedRequests() {
//   const [filter, setFilter] = useState<'all' | 'ongoing' | 'completed' | 'scheduled'>('all')

//   const filteredRequests = mockAcceptedRequests.filter(
...
//                         <div>
//                           <h4 className="text-sm font-medium text-gray-300 mb-2">Volunteer Information</h4>
//                           <div className="space-y-2">
//                             <p className="text-sm text-gray-400">
//                               <span className="font-medium">Assigned Volunteer:</span> {request.assignedVolunteer}
//                             </p>
//                             <p className="text-sm text-gray-400">
//                               <span className="font-medium">Volunteer Contact:</span> {request.volunteerContact}
//                             </p>
//                             <p className="text-sm text-gray-400">
            ...
            <div className="flex-1">
              ...
              >
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 md:mb-8">
                  <h1 className="text-xl sm:text-2xl font-bold">Accepted Requests</h1>
                  <div className="flex flex-wrap gap-2">
                    <button
                      onClick={() => setFilter('all')}
                  ...
                  {filteredRequests.map((request) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                          <h4 className="text-xs sm:text-sm font-medium text-gray-300 mb-2">Volunteer Information</h4>
                          <div className="space-y-1 sm:space-y-2">
                            <p className="text-xs sm:text-sm text-gray-400">
                              <span className="font-medium">Assigned Volunteer:</span> {request.assignedVolunteer}
                            </p>
